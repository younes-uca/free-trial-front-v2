...
export class FreeTrialDetailCreateAdminComponent implements OnInit {
    ...
    private _appropriateFreeTrials: Array<FreeTrialDto>;
...
, private studentService: StudentService, private freeTrialService: FreeTrialService
    ...
    this.freeTrialService.findAppropriateFreeTrials().subscribe((data) => this.appropriateFreeTrials = data);
...
private setValidation(value: boolean){
    ...
    public saveWithShowOption(showList: boolean){
     this.freeTrialDetailService.save().subscribe(freeTrialDetail=>{
        if(freeTrialDetail != null){
           this.freeTrialDetails.push({...freeTrialDetail});
           this.createFreeTrialDetailDialog = false;
           this.submitted = false;
           this.selectedFreeTrialDetail = new FreeTrialDetailDto();

        }else{
            this.messageService.add({severity: 'error', summary: 'Erreurs',detail: 'Free trial detail existe déjà' });
        }
    ...
    get appropriateFreeTrials(): Array<FreeTrialDto> {
        return this._appropriateFreeTrials;
    }

    set appropriateFreeTrials(value: Array<FreeTrialDto>) {
        this._appropriateFreeTrials = value;
    }
}
